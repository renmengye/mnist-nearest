...
local synthqa_statatt_model = {}

-------------------------------------------------------------------------------
function synthqa_statatt_model.createAttentionUnit(params, hidden, items)
...
-------------------------------------------------------------------------------
function synthqa_statatt_model.create(params, training)
    ...
    local attentionReshape, attentionModules = 
        synthqa_model.createMLPAttentionUnit(
...
synthqa_statatt_model.getVisualize = function(
    model, 
    attentionModule,
    data,
    rawData)
